(function () {
    ...
    var scheduleProfiles = {
        regular: {
            ...
            items: [
                { number: 1, label: "1 пара", start: "08:30", end: "10:00", note: "Учебное занятие" },
                { number: 2, label: "2 пара", start: "10:10", end: "11:40", note: "Учебное занятие" },
                { number: 3, label: "3 пара", start: "12:00", end: "13:30", note: "Учебное занятие" },
                { number: 4, label: "4 пара", start: "13:40", end: "15:10", note: "Учебное занятие" },
                { number: 5, label: "5 пара", start: "15:20", end: "16:50", note: "Дополнительное занятие" },
                { number: 6, label: "6 пара", start: "17:00", end: "18:30", note: "Вечерний поток" }
            ]
        },
        monday: {
            label: "Понедельник",
        ...
        short: {
            ...
            items: [
                { number: 1, label: "1 пара", start: "08:30", end: "09:50", note: "Сокращённый формат" },
                { number: 2, label: "2 пара", start: "10:00", end: "11:20", note: "Сокращённый формат" },
                { number: 3, label: "3 пара", start: "11:40", end: "13:00", note: "Сокращённый формат" },
                { number: 4, label: "4 пара", start: "13:10", end: "14:30", note: "Сокращённый формат" },
                { number: 5, label: "5 пара", start: "14:40", end: "16:00", note: "Сокращённый формат" }
            ]
        }
    };
